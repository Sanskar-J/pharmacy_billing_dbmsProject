...
cursor = conn.cursor()
cursor.execute(
    "CREATE TABLE EMP_DETAILS(EID INT(10) PRIMARY KEY, NAME VARCHAR(20), PASSWORD VARCHAR(20), PHNO BIGINT(10) UNIQUE)")
cursor.execute(
    "CREATE TABLE ADMIN_DETAILS(AID INT(10) PRIMARY KEY, NAME VARCHAR(20), PASSWORD VARCHAR(20), PHNO BIGINT(10) UNIQUE)")
cursor.execute(
